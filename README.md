...
| Android | ✅ Builds (`scripts/build-android.sh`, CI: `build-android.yml`) — arm64-v8a, Vulkan, on-screen gamepad with a full layout editor. See [docs/ANDROID.md](docs/ANDROID.md). |
